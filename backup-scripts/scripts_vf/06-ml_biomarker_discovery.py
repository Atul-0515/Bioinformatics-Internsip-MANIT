...
class MicrobiomeBiomarkerDiscovery:
    ...
    def evaluate_models(self, results, class_names, level):
        ...
        cv_acc_mean = [
            results[m]["cv_accuracy_mean"] for m in models
        ]  # FIXED: use cv_accuracy_mean
        cv_std = [
            results[m]["cv_accuracy_std"] for m in models
        ]  # FIXED: use cv_accuracy_std
        ...
        with open(report_file, "w") as f:
            ...
            for name, result in results.items():
                ...
                f.write(
                    f"CV Precision: {result['cv_precision_mean']:.4f}\n"
                )  # ADD THESE
